...
const imgAprovado = '<img src="./images/aprovado.png" alt="Emoji celebrando" title="Aprovado" />'
const imgReprovado = '<img src="./images/reprovado.png" alt="Emoji decepcionado" title ="Reprovado" />'
const atividades = []
const notas = []
